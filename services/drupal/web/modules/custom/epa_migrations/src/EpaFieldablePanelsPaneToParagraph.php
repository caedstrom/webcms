      ...
      switch ($pane->bundle) {
        case 'fieldable_panels_pane':
          ...
          if (isset($body_field['value'])) {
            $body_field['value'] = $this->transformWysiwyg($body_field['value'], $this->entityTypeManager, $record['is_skinny_pane'] ?? FALSE);
        ...
        case 'link_list':
          ...
          // Transform body field content.
          $body_field = $body_field_query->execute()->fetchAssoc() ?: [];
          $body_field['value'] ? $body_field['value'] = $this->transformWysiwyg($body_field['value'], $this->entityTypeManager, $record['is_skinny_pane'] ?? FALSE) : FALSE;
